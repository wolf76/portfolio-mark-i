<template>
  <div class="naresh-portfolio-intro">
    <div class="naresh-portfolio-intro__media">
      <CustomMediaIcons :isShadowEnabled="false" />
    </div>
...
export default {
  ...
  methods: {
    animateIntro() {
      ...
      tl.to(
        '.naresh-portfolio-intro__head__callout',
        {
          scale: 1,
          duration: 1,
